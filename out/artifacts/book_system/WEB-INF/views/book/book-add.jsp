    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="bno" name="bno" required="" lay-verify="required|bno"
                       autocomplete="off" class="layui-input" placeholder="请输入 bXX">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="bname" name="bname" required="" lay-verify="required|bname"
    ...
    layui.use(['form', 'layer'], function () {
        ...
        form.verify({
            ...
            bno: (val, item) => {
                if (!/^b\d{1,4}}$/.test(val)) {
                    // [b0,b9999]
                    return "bno 范围为 [b0, b9999]"
                }
            },
            bname: (val, item) => {
                if (!/^《.{1,20}》$/.test(val)) {
                    return "bname 格式为 《xx》 len(x) [1,20]"
                }
            }
        })
        //监听提交 (listen submit)
